...
gff_name = 'TM-1.gff'
def index(request):
    # 完全模仿id_search视图中的工作配置
    # 使用loc参数而不是region参数
    context = {
        'jbrowse_url': f'/static/jbrowse/index.html?config=config.json&assembly={genome_name}&type=LinearGenomeView&tracks={gff_name}&loc={location}'
    }
