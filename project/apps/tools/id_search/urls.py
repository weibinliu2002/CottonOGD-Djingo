...
from .views import  IdSearchFormAPIView, SequenceAPIView, SequenceByPositionAPIView
...
urlpatterns = [
    ...
    path('api/sequence/position/', SequenceByPositionAPIView.as_view(), name='sequence_by_position_api'),
]
